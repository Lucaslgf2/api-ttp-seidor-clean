import { IDbFindUtilizacaoVeiculoById, IDbFindUtilizacaoVeiculos } from '@/data/protocols/utilizacao-veiculo/db-find-utilizacao-veiculo'
import { IDbInsertUtilizacaoVeiculo } from '@/data/protocols/utilizacao-veiculo/db-insert-utilizacao-veiculo'
import { IDbUpdateUtilizacaoVeiculoById } from '@/data/protocols/utilizacao-veiculo/db-update-utilizacao-veiculo'
