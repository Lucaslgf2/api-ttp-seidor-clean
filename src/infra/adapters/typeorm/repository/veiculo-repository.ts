import { IDbDeleteVeiculoById } from '@/data/protocols/veiculo/delete-veiculo'
import { IDbFindVeiculoById, IDbFindVeiculos } from '@/data/protocols/veiculo/find-veiculo'
import { IDbInsertVeiculo } from '@/data/protocols/veiculo/insert-veiculo'
import { IDbUpdateVeiculoById } from '@/data/protocols/veiculo/update-veiculo'
